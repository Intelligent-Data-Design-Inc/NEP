...
- **Modernized Branding**: Top-level documentation uses the canonical NEP name and reflects the current NetCDF-centric architecture.
...
- **Main Documentation**:
  ...
  - `docs/Doxyfile.in` updated to describe NEP as a "NetCDF Expansion Pack" and to include `build-options.md` in the input set.
