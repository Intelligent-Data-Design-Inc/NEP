...
- Top-level product title uses outdated product positioning.
...
- **Steps**:
  - Change the main title to use the canonical NEP name and current product positioning.
  - Keep HDF5 references only in technical sections where it is an implementation dependency, not in the product tagline.
- **Acceptance Criteria**:
  - Main page title/tagline uses the canonical NEP name and current positioning.
