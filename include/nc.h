 ...
 * Category: DIRECT — included by geotifffile.c, grib2file.c
 * Elimination path: REQUIRES UPSTREAM CHANGE — NC struct and NC_check_id() have no
 *   public API equivalents. See https://github.com/Unidata/netcdf-c/issues/3277
