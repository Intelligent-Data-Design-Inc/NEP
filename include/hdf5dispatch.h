 ...
 * Source: https://github.com/Unidata/netcdf-c/blob/main/libhdf5/hdf5dispatch.h
 * Do not edit. See docs/plan/v1.5.5-header-cleanup-map.md for elimination plan.
 * Category: DIRECT - used by cdfdispatch.c, geotiffdispatch.c for HDF5_inq_dim.
 * Elimination path: HDF5_inq_dim needed in dispatch tables; may be installable
 *   from netcdf-c if exposed as public headers. */
/**
 * @file
