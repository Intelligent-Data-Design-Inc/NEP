...
caption = "\n".join([
    ...
    "",
    "shuffle=off: zstd compresses raw float bytes.",
    ...
    "",
    "Negative levels (-7 to -1): ultra-fast, minimal ratio. Level 1: fast default.",
    "Levels 3\u201322: increasing ratio at rising CPU cost. Higher ratio is better.",
])
