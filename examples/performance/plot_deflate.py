"""Generate deflate performance plots from deflate.c CSV output (black and white).

Usage:
    ./deflate > deflate_results.csv
    python3 plot_deflate.py

Reads:  deflate_results.csv
Writes: deflate_performance.jpg

Columns expected: deflate_level,shuffle,compressed_bytes,ratio,write_s,read_s
"""
...
INPUT  = "deflate_results.csv"
OUTPUT = "deflate_performance.jpg"
...
try:
    ...
    print(f"Error: {INPUT} not found. Run './deflate > {INPUT}' first.",
          file=sys.stderr)
    sys.exit(1)
