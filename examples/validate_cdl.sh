...
if [[ -n "${LD_LIBRARY_PATH:-}" ]]; then
    export LD_LIBRARY_PATH=/home/ed/NEP/src/.libs:/usr/local/hdf5-2.0.0/lib:/usr/local/netcdf-c-4.10.0/lib:$LD_LIBRARY_PATH
else
    export LD_LIBRARY_PATH=/home/ed/NEP/src/.libs:/usr/local/hdf5-2.0.0/lib:/usr/local/netcdf-c-4.10.0/lib
fi
...
NCDUMP="/usr/local/netcdf-c-4.10.0/bin/ncdump"
